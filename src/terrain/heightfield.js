...
import {
    ROAD_DIR, ROAD_HALF_WIDTH, ROAD_SHOULDER, ROAD_BERM,
} from "../road/roadLayout.js";
...
export class Heightfield {
    ...
    async bake() {
        ...
        // The highway corridor is graded into the bake, so the CPU mirror the
        // road mesh is built against describes the same ground.
        _roadOrigin.set(0, 0);
        _roadDir.set(ROAD_DIR.x, ROAD_DIR.z);
        this.heightTex.setVector2("roadOrigin", _roadOrigin);
        this.heightTex.setVector2("roadDir", _roadDir);
        this.heightTex.setFloat("roadHalfWidth", ROAD_HALF_WIDTH);
        this.heightTex.setFloat("roadShoulder", ROAD_SHOULDER);
        this.heightTex.setFloat("roadBerm", ROAD_BERM);
...
const _roadOrigin = new Vector2();
const _roadDir = new Vector2();
