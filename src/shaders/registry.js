...
import blizzardVert from "./blizzard.vertex.wgsl?raw";
import blizzardFrag from "./blizzard.fragment.wgsl?raw";
...
import roadVert from "./road.vertex.wgsl?raw";
import roadFrag from "./road.fragment.wgsl?raw";
import roadDepthVert from "./roadDepth.vertex.wgsl?raw";
import roadPrepassVert from "./roadPrepass.vertex.wgsl?raw";
...
const SHADERS = {
    ...
    blizzardVertexShader: blizzardVert,
    blizzardPixelShader: blizzardFrag,
    ...
    roadVertexShader: roadVert,
    roadPixelShader: roadFrag,
    roadDepthVertexShader: roadDepthVert,
    roadPrepassVertexShader: roadPrepassVert,
