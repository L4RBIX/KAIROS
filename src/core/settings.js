...
export const S = {
    ...
    windStrength: 1.0,
    /**
     * Overcast, 0..1. Was a constant inside `Sky.render`; the weather director
     * drives it now, because cloud cover is how a storm dims this scene. The
     * sun's own intensity cannot be used for that — see the note in
     * `app/weatherDirector.js`.
     */
    cloudAmount: 0.45,
    /**
     * GPU blizzard — product storm volume. Driven by WeatherDirector.
     * Density 0..1 gates how many of the preallocated grains are alive.
     */
    blizzardDensity: 0.0,
    blizzardOpacity: 0.0,
    /** Strength of the near-camera streak layer, 0..1. */
    nearSnowIntensity: 0.0,
    /** Smooth gust amount modulating runtime wind, 0..1. */
    gustStrength: 0.0,
    /**
     * Runtime storm wind in world XZ (NOT baked `windDirection`). Consumed by
     * the GPU blizzard; terrain anisotropy stays on `windDirection`.
     */
    runtimeWindX: 0.0,
    runtimeWindZ: 0.0,
...
export const SCHEMA = [
    ...
    },
    {
        ...
        items: [
            ...
            { k: "windStrength", l: "Wind strength", t: "f", min: 0, max: 4.5, step: 0.01 },
            { k: "cloudAmount", l: "Cloud", t: "f", min: 0, max: 1, step: 0.01 },
            { k: "blizzardDensity", l: "Blizzard dens.", t: "f", min: 0, max: 1, step: 0.01 },
            { k: "blizzardOpacity", l: "Blizzard opac.", t: "f", min: 0, max: 1, step: 0.01 },
            { k: "nearSnowIntensity", l: "Near snow", t: "f", min: 0, max: 1, step: 0.01 },
            { k: "gustStrength", l: "Gusts", t: "f", min: 0, max: 1, step: 0.01 },
